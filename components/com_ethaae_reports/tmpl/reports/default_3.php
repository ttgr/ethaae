...
//Factory::getApplication()->enqueueMessage($db->replacePrefix((string) Text::_('COM_ETHAAE_REPORTS_REPORTS_FK_UNIT_ID_QUERY_3')), 'notice');

$this->filterForm->setFieldAttribute('filter_fk_unit_id', 'query',Text::_('COM_ETHAAE_REPORTS_REPORTS_FK_UNIT_ID_QUERY_3'));
