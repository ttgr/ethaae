...
namespace Ethaaunitsinfo\Component\Ethaae_units_info\Site\View\Unitinfo;
// No direct access
...
use Ethaaunitsinfo\Component\Ethaae_units_info\Site\Model\InstitutesinfoModel;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
        ...
        $this->unitid = $app->getInput()->getInt('id',0);
        $this->lang = Ethaae_reportsHelper::getCurrentLangSef();
        $this->item = Ethaae_reportsHelper::getUnitFullInfo($this->unitid,$this->lang);
        $this->item->reports    = Ethaae_reportsHelper::getUnityReports($this->unitid);
        $this->item->studies    = Ethaae_reportsHelper::getUnitChildren($this->unitid, $this->lang);
