...
/**
 * Institutesinfo model.
 *
 * @since  1.1.0
 */
class InstitutesinfoModel extends AdminModel
{
	/**
	 ...
	 * @since  1.1.0
	 */
	protected $text_prefix = 'COM_ETHAAE_UNITS_INFO';
	 ...
	 * @since  1.1.0
	 */
	public $typeAlias = 'com_ethaae_units_info.institutesinfo';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_ethaae_units_info.institutesinfo', 
								'institutesinfo',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_ethaae_units_info.edit.institutesinfo.data', array());
	...
	/**
	 * Method to duplicate an Institutesinfo
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_ethaae_units_info'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ethaae_institutes_info');
				$max             = $db->loadResult();
