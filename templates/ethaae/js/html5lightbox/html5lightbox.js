    ...
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            inst.loadElem = function (elem) {
                ...
                //Tasos check the type of the element and enable the corresponding function
            ...
            inst.showPDF = function (elem) {
                if (inst.options.enablepdfjs) {
                    if ((inst.options.isIPhone && inst.options.openpdfinnewtaboniphone) || (inst.options.isIPad && inst.options.openpdfinnewtabonipad)) {
                        var win = window.open(elem[ELEM_HREF], "_self");
                        win.focus();
                        inst.finish();
                        return;
                    }
            ...
            inst.checkType = function (href) {
                ...
                //Tasos tell url containing "?task=bowsdoc.download" should be PDF
                if (href.match(/[^\.]\.(download)/i)) return 5;
