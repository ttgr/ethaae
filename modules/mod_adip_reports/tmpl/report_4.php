...
?>
<ul class="latestnews report-4 <?php echo $moduleclass_sfx; ?> mod-list">
            ...
            <div class="clearfix">
                ...
                <div class="title">
                    <a class="html5lightbox" href="<?php echo $item->link; ?>" itemprop="url">
                        <span itemprop="name" class="title"><?php echo $item->{'institute_title_'.$langSEF}." :: ".$item->{'unit_short_code_'.$langSEF}." - ".$item->{'unit_title_'.$langSEF}; ?></span>
                    </a>
                </div>
            </div>
        </li>
