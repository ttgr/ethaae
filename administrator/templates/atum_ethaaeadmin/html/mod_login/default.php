...
<form class="form-validate" action="<?php echo Route::_('index.php', true); ?>" method="post" id="form-login">
    <fieldset>
        ...
        <div class="mt-4">
            ...
            <hr>
            <div class="form-group">
                <a href="<?php echo JURI::root().'administrator/?hqarequest=ssologin';?> " class="btn btn-primary w-100 btn-lg">
                    <span class="icon-lock icon-white"></span> <?php echo JText::_('HQA SSO Login'); ?>
                </a>
            </div>
