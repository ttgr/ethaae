...
<table class="table table-striped" id="fileslist">
    ...
    <tr>
        ...
        <th class='left'>
            <?php echo JText::_('COM_ETHAAE_REPORTS_FILES_FILENAME'); ?>
        </th>
        <th class='left'>
            <?php echo JText::_('COM_ETHAAE_REPORTS_FILES_TITLE'); ?>
        </th>
        <th class='left'>
            <?php echo JText::_('COM_ETHAAE_REPORTS_FILES_TYPE'); ?>
        </th>
        <th class='center'>
            <?php echo JText::_('COM_ETHAAE_REPORTS_FILES_LANG'); ?>
        </th>
        <th class='center'>
            <?php echo JText::_('COM_ETHAAE_REPORTS_FILES_STATUS'); ?>
        </th>
    </tr>
    </thead>
    <tbody>
